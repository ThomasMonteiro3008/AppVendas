...
class BannerVendedor(FloatLayout):
    def __init__(self, **kwargs):
        ...
        link = f'https://appvendas-283a2-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        ...
        imagem = ImageButton(source=f'icones/fotosperfil/{avatar}',
                             pos_hint= {'right':0.4, 'top':0.9 }, size_hint= (0.3, 0.8),
                             on_release=partial(meu_aplicativo.carregar_vendas_vendedor, id_vendedor))
